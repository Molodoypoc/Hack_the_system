...
define config.name = _("Взломать систему")
...
define build.name = "Hack_the_system"
...
define config.main_menu_music = "chill_guy_song.ogg"
...
define config.save_directory = "game_opd-1732014670"
